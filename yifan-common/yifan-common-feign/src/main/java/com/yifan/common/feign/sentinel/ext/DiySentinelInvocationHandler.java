...
import com.yifan.common.feign.annotation.FeignRetry;
 ...
 *
 * @author Wenzhou
 * @since 2023/5/6 16:56
 */
@Slf4j
public class DiySentinelInvocationHandler implements InvocationHandler {
    ...
    DiySentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DiySentinelInvocationHandler) {
            DiySentinelInvocationHandler other = (DiySentinelInvocationHandler) obj;
