 ...
 */
public class DiyFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
    ...
    private void registerFeignClients(BeanDefinitionRegistry registry) {
        ...
        for (String className : feignClients) {
            try {
                ...
                if (attributes == null || registry.containsBeanDefinition(className)) {
                    continue;
                }
                ...
                if (attributes.containsKey(CONTEXT_ID)) {
                    String contextId = getContextId(attributes);
                    aliasBuilder.append(contextId);
                    definition.addPropertyValue(CONTEXT_ID, contextId);
                } else {
    ...
    private void validate(Map<String, Object> attributes) {
        ...
        FeignClientsRegistrar.validateFallback(Objects.requireNonNull(annotation).getClass(FALLBACK));
        FeignClientsRegistrar.validateFallbackFactory(Objects.requireNonNull(annotation).getClass(FALLBACK_FACTORY));
    }
    ...
    private String getContextId(Map<String, Object> attributes) {
        String contextId = (String) attributes.get(CONTEXT_ID);
    ...
    private String getClientName(@Nullable Map<String, Object> client) {
        ...
        String value = (String) client.get(CONTEXT_ID);
        if (!StringUtils.hasText(value)) {
