package com.yifan.gateway.filter;
...
import com.yifan.common.core.exception.ValidateCodeException;
import com.yifan.common.core.util.DiyWebUtils;
import com.yifan.common.core.util.R;
import com.yifan.gateway.config.GatewayConfigProperties;
...
public class ValidateCodeGatewayFilter extends AbstractGatewayFilterFactory<Object> {
    ...
    public GatewayFilter apply(Object config) {
        return (exchange, chain) -> {
            ...
            boolean isIgnoreClient = configProperties.getIgnoreClients().contains(DiyWebUtils.getClientId(request));
            try {
