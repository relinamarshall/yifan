/*
 ...
 Source Schema         : yifan_job

 Target Server Type    : MySQL
 Target Server Version : 80021
 File Encoding         : 65001

 Date: 11/05/2023 09:33:31
*/
...
CREATE TABLE `xxl_job_group`  (
  ...
  `address_list` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '执行器地址列表，多地址逗号分隔',
...
CREATE TABLE `xxl_job_info`  (
  ...
  `schedule_type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'NONE' COMMENT '调度类型',
  `schedule_conf` varchar(128) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '调度配置，值含义取决于调度类型',
  `misfire_strategy` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'DO_NOTHING' COMMENT '调度过期策略',
