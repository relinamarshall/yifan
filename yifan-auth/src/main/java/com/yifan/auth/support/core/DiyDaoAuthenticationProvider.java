...
import com.yifan.common.security.service.ExtUserDetailsService;
 ...
 *
 * @author Wenzhou
 * @since 2023/5/11 15:02
 */
public class DiyDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    public DiyDaoAuthenticationProvider() {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        // app 模式不用校验密码
        String grantType = DiyWebUtils.getRequest().get().getParameter(OAuth2ParameterNames.GRANT_TYPE);
    ...
    protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
        ...
        HttpServletRequest request = DiyWebUtils.getRequest()
                .orElseThrow(
