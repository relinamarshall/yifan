...
public class NacosApiExceptionHandler {
    ...
    public static final String GOT_ONE_EXCEPTION = "got exception. {}";
    public static final String GOT_TWO_EXCEPTION = "got exception. {} {}";

    @ExceptionHandler(NacosApiException.class)
    public ResponseEntity<Result<String>> handleNacosApiException(NacosApiException e) {
        LOGGER.error(GOT_TWO_EXCEPTION, e.getErrAbstract(), e.getErrMsg());
    ...
    public ResponseEntity<Result<String>> handleNacosException(NacosException e) {
        LOGGER.error(GOT_ONE_EXCEPTION, e.getErrMsg());
    ...
    public Result<String> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        LOGGER.error(GOT_TWO_EXCEPTION, e.getMessage(), ExceptionUtil.getAllExceptionMsg(e));
